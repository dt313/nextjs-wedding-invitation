        ...
        >
          <SwiperSlide>
            <div className={cx("img-wrapper")}>
              <img className={cx("img")} src={imgs[0]?.img} />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className={cx("img-wrapper")}>
              <img className={cx("img")} src={imgs[1]?.img} />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className={cx("img-wrapper")}>
              <img className={cx("img")} src={imgs[2]?.img} />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className={cx("img-wrapper")}>
              <img className={cx("img")} src={imgs[3]?.img} />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className={cx("img-wrapper")}>
              <img className={cx("img")} src={imgs[4]?.img} />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className={cx("img-wrapper")}>
              <img className={cx("img")} src={imgs[5]?.img} />
            </div>
          </SwiperSlide>{" "}
          <SwiperSlide>
            <div className={cx("img-wrapper")}>
              <img className={cx("img")} src={imgs[6]?.img} />
            </div>
          </SwiperSlide>{" "}
          <SwiperSlide>
            <div className={cx("img-wrapper")}>
              <img className={cx("img")} src={imgs[7]?.img} />
            </div>
          </SwiperSlide>{" "}
          <SwiperSlide>
            <div className={cx("img-wrapper")}>
